...
@endphp
<div class="tour-card  relative select-none shadow">
    <a href="{{ route($tour->group . '.show', [$category, $tour]) }}" class="h-72 overflow-hidden cursor-pointer">
    ...
    <div class="flex flex-col p-4 md:px-3 md:py-4 gap-2">
        ...
        <a href="{{ route($tour->group . '.show', [$category, $tour]) }}"
            class=" text-safety-orange md:text-[19px] font-semibold whitespace-normal line-clamp-2 min-h-[50px] hover:text-red-700 transition-all">
            {{$tour->title}}
        </a>
        ...
        <div class="flex md:flex-row items-center  justify-between">
            <div class="flex md:flex-row  items-center gap-1  pb-2">
                <svg height="26px" width="26px" viewBox="0 0 24 24" fill="#ff6700" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex md:flex-row justify-start items-center gap-1 mb-1">
                <svg class="fill-current" height="24px" width="24px" version="1.1" id="Capa_1"
                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 235.517 235.517" fill="#ff6700" stroke="#ff6700">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                    <g id="SVGRepo_iconCarrier">
                        <g>
        ...
        <a href="{{ route($tour->group . '.show', [$category, $tour]) }}" class="flex items-center justify-center">
            <button
                class="font-medium text-Primary text-[16px] tracking-widest rounded-full transition-all duration-500
                          bg-[#f9f9f9]  border-2 border-safety-orange shadow-md hover:bg-orange-600 hover:text-white px-14 py-2">
                Explore
            </button>
        </a>
    </div>
